...
import { n as UserButton, r as useCurrentUserState, t as SignInGate } from "./gates-p-7fXblz.mjs";
...
import { A as Library, B as CircleHelp, C as Printer, D as Mic, E as Pause, F as Heart, G as CalendarDays, H as ChevronLeft, I as Headphones, J as BookOpen, K as Building2, L as GraduationCap, M as Landmark, N as House, O as MessagesSquare, P as Highlighter, R as Download, S as Repeat1, T as Play, U as ChevronDown, V as ChevronRight, W as Check, X as Badge, Y as Bell, _ as Search, b as RotateCcw, c as Square, d as SkipBack, f as Signpost, g as Send, h as Settings, i as Type, j as Languages, k as Lightbulb, l as Sparkles, m as Share2, n as Volume2, o as Trash2, p as Shield, q as Bookmark, r as UserRound, s as Table2, t as X, u as SkipForward, v as ScrollText, w as Plus, x as Repeat, y as Scale, z as CirclePause } from "../_libs/lucide-react.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as create } from "../_libs/zustand.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-CczT8q8W.js
var routes_CczT8q8W_exports = /* @__PURE__ */ __exportAll({
	a: () => pushStudyMs,
	c: () => nextSabrDate,
	component: () => Home,
	d: () => registerSw,
...
var pending$1 = null;
function loadMushaf() {
	if (cache$3) return Promise.resolve(cache$3);
	if (!pending$1) pending$1 = fetch("/quran/mushaf.json").then((r) => {
...
var pullStudy = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("632e6b3574baf124d217555a917cdeb5629e78482b89d6c7db7c3418438d4ff4"));
var pushStudyMs = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("13fe003aadd8fd4d8a8764d84bfb5d4785cc6dfff0b2a3c91500b7839edf93a8"));
var addMemory = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("5b10fd58501f96779c0fd12f08dcd0dfcc347317a52ad23e89b6abb45165bd65"));
var pushProgress = createServerFn({ method: "POST" }).middleware([authMiddleware]).validator((input) => input).handler(createSsrRpc("2e220885203c181624c99621ca46915e434842c25103a3f7091e3e83dd1210d3"));
var dumpStudy = createServerFn({ method: "GET" }).middleware([authMiddleware]).handler(createSsrRpc("6bbe3ef2221119cd0ae0c4dd6679ff612ee071912de4f964be7359e16ed43bbb"));
...
function SheikhSeal({ size = 148, onClick }) {
	const [ok, setOk] = (0, import_react.useState)(true);
...
var KEY$3 = "mizan.v1.studyMs";
var FREE_MS = 72e5;
function readStudyMs() {
	try {
		const n = Number(localStorage.getItem(KEY$3) || 0);
		return Number.isFinite(n) && n > 0 ? n : 0;
	} catch {
		return 0;
	}
}
function addStudyMs(delta) {
	const next = readStudyMs() + Math.max(0, delta);
	try {
		localStorage.setItem(KEY$3, String(next));
	} catch {}
	return next;
}
...
function persist$2() {
	try {
		const snap = snapshot();
		localStorage.setItem(KEY$2, JSON.stringify(snap));
...
function applyServerProgress(payload) {
	try {
...
function CabinetSheet() {
	...
	const [mems, setMems] = (0, import_react.useState)([]);
	const [studyMs, setStudyMs] = (0, import_react.useState)(0);
	...
	(0, import_react.useEffect)(() => {
		...
		pushStudyMs({ data: { studyMs: readStudyMs() } }).catch(() => {});
	}, [open, user]);
	if (!open) return null;
	const hours = (studyMs / 36e5).toFixed(1);
	function backupLocal() {
		...
		a.download = `mizan-backup-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.json`;
		a.click();
	}
	async function backupServer() {
		try {
			...
			const a = document.createElement("a");
			a.href = URL.createObjectURL(blob);
			a.download = `mizan-server-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.json`;
			a.click();
		} catch {
			backupLocal();
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "fixed inset-0 z-[90] grid place-items-end bg-black/50 p-3 sm:place-items-center",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
			className: "max-h-[90dvh] w-full max-w-md overflow-y-auto rounded-[28px] border border-[var(--line)] bg-[var(--bg)] p-5",
			children: [
				...
				isPending ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "mt-4 h-10 animate-pulse rounded-full bg-[var(--surface)]" }) : null,
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									"Гость: ",
									hours,
									" ч из 2. Потом вход. Google, почта или X. Telegram на этой платформе нет — почта его заменяет."
								]
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
								to: "/login",
								className: "btn-glow grid min-h-12 place-items-center rounded-full",
								children: "Войти"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "secondary",
								onClick: backupLocal,
								children: "Скачать копию на компьютер"
							})
						]
					}),
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-sm",
								children: user?.displayName || user?.primaryEmail || "Студент"
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							...
							children: [
								"Учёба: ",
								hours,
								" ч. Память на сервере, завтра модель помнит сегодняшнее."
							]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
							...
							children: mems.slice(0, 8).map((m, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
...
function hadithChain(h, locale) {
	let narrator = (h.ru.match(/со слов\s+(.+?)(?=\s*,\s*да будет|\s*:\s|\s+я слышал|\s+что\s)/i)?.[1] ?? "").replace(/\s+/g, " ").trim();
	if (!narrator) narrator = h.refRu;
	const narratorAr = (h.ar.match(/عَنْ[\s\u00a0]+(.+?)[\s\u00a0]+(?:رَضِيَ|قَالَ)/)?.[1] ?? "").replace(/\s+/g, " ").trim();
	const books = locale === "ar" ? h.ar.match(/رَوَاهُ[\s\S]{0,180}/)?.[0]?.replace(/\s+/g, " ").trim() || h.ref : h.refRu;
	const collection = locale === "ar" ? `الأربعون النووية، الحديث ${h.n}` : locale === "en" ? `an-Nawawi, hadith ${h.n}` : `ан-Навави, хадис ${h.n}`;
	return {
		narrator,
		narratorAr,
		prophet: locale === "ar" ? "رسول الله ﷺ" : locale === "en" ? "the Messenger of Allah ﷺ" : "Посланник Аллаха ﷺ",
		books,
		collection,
		gradeKey: h.n
	};
...
function HadithSource({ h, locale }) {
	const c = hadithChain(h, locale);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "hadith-chain",
		"data-go": "hadith-chain",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "hadith-chain-kicker",
				children: translate(locale, "hadith.chain")
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "hadith-chain-label",
				children: translate(locale, "hadith.chain.narrator")
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "hadith-chain-name",
				children: c.narrator
			}),
			c.narratorAr ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "hadith-chain-ar",
				lang: "ar",
				children: c.narratorAr
			}) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "hadith-chain-arrow",
				"aria-hidden": true,
				children: "↓"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "hadith-chain-name gold-flow",
				children: c.prophet
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "hadith-chain-arrow",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "hadith-chain-book",
				children: c.books
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "hadith-chain-meta",
				children: [
					c.collection,
					" · ",
...
function hearAsk(onText, lang = "ru-RU") {
	return hearAsk$1(onText, lang);
}
function Ctor() {
	if (typeof window === "undefined") return null;
	const w = window;
...
var clipCache = /* @__PURE__ */ new Map();
function cacheKey(text, lang, voice, rate, gender) {
	return `${voice}|${rate}|${gender}|${lang}|${text}`;
}
async function fetchClip(text, lang, gender, rate, voice) {
...
function playClip(clip, rate, mine) {
...
async function prefetchSpeak(text, lang = "ru-RU") {
	if (typeof window === "undefined") return;
	...
	for (const chunk of chunkText(prepared)) await fetchClip(chunk, lang, gender, rate, voice);
}
...
function HadithReader() {
	...
	(0, import_react.useEffect)(() => {
		...
		setSpeaking(null);
		setSource(false);
		prefetchSpeak(hadithAr(h), "ar-SA");
		if (meaning) prefetchSpeak(meaning, speakLang(locale));
	}, [h.n]);
	function back() {
		stopSpeak();
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					source ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HadithSource, {
						h,
						locale
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChipRow, {
...
function loadHisn() {
	...
	if (!pending) pending = fetch(`/hisn/book.json?v=3`).then((r) => {
...
var MARK = /[\u064B-\u065F\u0670\u06D6-\u06ED\u08D3-\u08FF\u0640]/;
var LETTER = /[\u0621-\u063A\u0641-\u064A\u0671]/;
var IZHAR = /* @__PURE__ */ new Set([
	"ء",
	"ه",
	"ع",
	"ح",
...
var IDGHAM_G = /* @__PURE__ */ new Set([
	"ي",
	"ن",
	"م",
	"و"
]);
var IDGHAM_N = /* @__PURE__ */ new Set(["ل", "ر"]);
var IQLAB = /* @__PURE__ */ new Set(["ب"]);
var IKHFA = /* @__PURE__ */ new Set([
	"ت",
	"ث",
	"ج",
	"د",
...
function beatsFor(rule) {
	...
	if (rule === "silent" || rule === "idghamNo") return .2;
	return 1;
}
function noonRule(next) {
	if (!next) return "none";
...
function maddKind(cs, i) {
	...
	if (!(letter === "ا" && has(prev, FATHA) || (letter === "و" || letter === "ۥ") && has(prev, DAMMA) && !has(c, FATHA) && !has(c, KASRA) || (letter === "ي" || letter === "ى") && has(prev, KASRA) && !has(c, FATHA) && !has(c, DAMMA))) return null;
	const nxt = nextLetter(cs, i);
	if (nxt && baseLetter(nxt.letter) === "ء") return "madd";
...
function paintText(text) {
	...
	for (let i = 0; i < cs.length; i++) {
		...
		if ((b === "ن" || b === "م") && has(c, SHADDA)) rules[i] = "ghunna";
		if (b === "ن" && isSakin(c) && !has(c, SHADDA)) rules[i] = noonRule(nxt);
		...
		if (c.letter === "ل") {
			const prev = prevLetter(cs, i);
			if (prev && (prev.letter === WASL || prev.letter === "ا" || prev.letter === "أ") && nxt && SHAMSI.has(baseLetter(nxt.letter))) rules[i] = "silent";
		}
	}
	return cs.map((c, i) => ({
		text: c.raw,
...
function wordBeats(ar, next = "") {
	const sum = paintWord(ar, next).reduce((a, p) => a + Math.max(.2, p.beats), 0);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1 text-[11px] uppercase tracking-[0.12em] text-[var(--muted)]",
					children: c.beats
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-2 text-sm",
...
function SheikhSheet({ open, seed, onClose }) {
	...
	async function send(raw) {
		...
		try {
			try {
				payload.memories = (await pullStudy()).memories.map((m) => m.body).slice(0, 12);
			} catch {
				payload.memories = [];
			}
...
function HadithDay() {
	...
	const [source, setSource] = (0, import_react.useState)(false);
	const [tongue, setTongue] = (0, import_react.useState)("ru");
	const playId = (0, import_react.useRef)(0);
	(0, import_react.useEffect)(() => () => stopSpeak(), []);
	(0, import_react.useEffect)(() => {
		prefetchSpeak(arabic, "ar-SA");
		if (meaning) prefetchSpeak(meaning, speakLang(locale));
	}, [
		arabic,
		meaning,
	...
	function flipTongue(next) {
		setTongue(next);
		if (speaking) runSpeak(next);
	}
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					body ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: cn("hadith-day-mean", (full || tongue === "ar") && "is-full"),
						lang: tongue === "ar" ? "ar" : void 0,
						dir: tongue === "ar" ? "rtl" : void 0,
						children: body
					}) : null
				]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						...
						children: tongue === "ar" ? translate(locale, "hadith.lang.ru") : translate(locale, "hadith.lang.ar")
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
...
function HomeView() {
	...
	const stopMic = (0, import_react.useRef)(null);
	(0, import_react.useEffect)(() => {
		...
		lessons: [
			{
				...
				minutes: 20,
				goal: "هذا ذلك",
				teach: "هذا — близко. ذلك — далеко. Имя после них в именительном.",
				drill: "letters",
				exampleAr: "هَٰذَا كِتَابٌ",
				exampleRu: "Это — книга."
			},
			{
				n: 2,
				...
				minutes: 20,
				goal: "بيت مسجد",
				teach: "Имена. Алиф-лям ال делает слово определённым.",
				drill: "connect",
				exampleAr: "الْبَيْتُ كَبِيرٌ",
				exampleRu: "Дом большой."
			},
			{
				n: 3,
				title: "У него / у неё",
				minutes: 25,
				goal: "له لها",
				teach: "Предлог لِ + местоимение. Идафа: كِتَابُ الطَّالِبِ.",
				drill: "harakat",
				exampleAr: "لَهُ قَلَمٌ",
				exampleRu: "У него ручка."
			},
			{
				n: 4,
				title: "Где?",
				minutes: 20,
				goal: "أين",
				teach: "أينَ + اسم. Ответ: في، على، تحت.",
				drill: "read",
				exampleAr: "أَيْنَ الْكِتَابُ؟",
				exampleRu: "Где книга?"
			},
			{
				n: 5,
				title: "Глагол прошедшего",
				minutes: 25,
				goal: "فَعَلَ",
				teach: "Трёхсогласный корень. كَتَبَ — он написал. ذَهَبَ — он пошёл.",
				drill: "harakat",
				exampleAr: "كَتَبَ الدَّرْسَ",
				exampleRu: "Он написал урок."
			},
			{
				n: 6,
				title: "Ты и я",
				minutes: 25,
				goal: "أنا أنت",
				teach: "Местоимения. Глагол меняется: كَتَبْتُ — я написал.",
				drill: "read",
				exampleAr: "أَنَا طَالِبٌ",
				exampleRu: "Я студент."
			},
			{
				n: 7,
				...
				minutes: 20,
				goal: "ـة",
				teach: "Та-марбута. هذه طالبة. Большинство имён на ة — женский род.",
				drill: "connect",
				exampleAr: "هَٰذِهِ مَدْرَسَةٌ",
				exampleRu: "Это школа."
			},
			{
				n: 8,
				title: "Чтение с мусхафа",
				minutes: 30,
				goal: "Фатиха с листа",
				teach: "Буква + харакат без догадки. Слух Хусари, глаза в мусхафе.",
				drill: "read",
				exampleAr: "بِسْمِ ٱللَّهِ",
				exampleRu: "С именем Аллаха."
			}
		]
	},
	{
		...
		lessons: [
			{
				...
				minutes: 15,
				goal: "السلام عليكم",
				teach: "Приветствие. وعليكم السلام. كيف حالك؟ — بخير، والحمد لله.",
				drill: "letters",
				exampleAr: "السَّلَامُ عَلَيْكُمْ",
				exampleRu: "Мир вам."
			},
			{
				n: 2,
				...
				minutes: 20,
				goal: "ما اسمك",
				teach: "ما اسمُكَ؟ اسمي… من أين أنت؟",
				drill: "harakat",
			...
			},
			{
				...
				minutes: 20,
				goal: "أب أم",
				teach: "أَب، أُم، أَخ، أُخْت، ابْن، بِنْت.",
				drill: "connect",
				exampleAr: "هَٰذَا أَبِي",
				exampleRu: "Это мой отец."
			},
			{
				n: 4,
				title: "Еда",
				minutes: 20,
				goal: "خبز ماء",
				teach: "Хочу / не хочу: أُرِيدُ. Просьба: مِنْ فَضْلِكَ.",
				drill: "read",
				exampleAr: "أُرِيدُ مَاءً",
				exampleRu: "Я хочу воду."
			},
			{
				n: 5,
				title: "Время намаза",
				minutes: 25,
				goal: "صلاة",
				teach: "الفجر الظهر العصر المغرب العشاء. Который час: الساعة…",
				drill: "read",
				exampleAr: "حَانَ وَقْتُ الصَّلَاةِ",
				exampleRu: "Наступило время молитвы."
			},
			{
				n: 6,
				title: "Рынок",
				minutes: 20,
				goal: "كم",
				teach: "كَمْ هَٰذَا؟ غَالٍ / رَخِيصٌ. Числа 1–10.",
				drill: "harakat",
				exampleAr: "كَمْ هَٰذَا؟",
				exampleRu: "Сколько это стоит?"
			},
			{
				n: 7,
				title: "Направление",
				minutes: 20,
				goal: "يمين يسار",
				teach: "يَمِين، يَسَار، أَمَام، خَلْف. اِذْهَبْ إِلَى…",
				drill: "connect",
				exampleAr: "الْمَسْجِدُ أَمَامَكَ",
				exampleRu: "Мечеть перед тобой."
			},
			{
				n: 8,
				title: "Короткий диалог",
				minutes: 25,
				goal: "говорить 8 фраз",
				teach: "Собери салам, имя, откуда, куда идёшь. Без бумаги.",
				drill: "read",
				exampleAr: "أَيْنَ تَذْهَبُ؟",
				exampleRu: "Куда ты идёшь?"
			}
		]
	},
	{
		...
		lessons: [
			{
				...
				minutes: 25,
				goal: "три буквы",
				teach: "Арабское слово живёт корнем. كَتَبَ كِتَاب كَاتِب مَكْتَب.",
				drill: "letters",
				exampleAr: "كَتَبَ",
				exampleRu: "написал"
			},
			{
				...
				minutes: 20,
				goal: "درس",
				teach: "دَرَسَ — учил. مَدْرَسَة — школа. دَرْس — урок.",
				drill: "connect",
				exampleAr: "دَرَسَ الطَّالِبُ",
				exampleRu: "Студент учил."
			},
			{
				n: 3,
				title: "Исм и фи‘ль",
				minutes: 25,
				goal: "اسم فعل",
				teach: "Имя и глагол. Предложение может начинаться с имени или с глагола.",
				drill: "harakat",
				exampleAr: "الْوَلَدُ كَتَبَ",
				exampleRu: "Мальчик написал."
			},
			{
				n: 4,
				title: "Идафа",
				minutes: 25,
				goal: "إضافه",
				teach: "كِتَابُ الطَّالِبِ — книга студента. Первое без артикля, второе несёт определённость.",
				drill: "read",
				exampleAr: "بَابُ الْمَسْجِدِ",
				exampleRu: "Дверь мечети."
			},
			{
				n: 5,
				title: "Причастие",
				minutes: 25,
				goal: "فاعل",
				teach: "Катиб — пишущий. Модель فَاعِل.",
				drill: "harakat",
				exampleAr: "هُوَ كَاتِبٌ",
				exampleRu: "Он пишущий / писатель."
			},
			{
				n: 6,
				title: "Масдар",
				minutes: 20,
				goal: "مصدر",
				teach: "Отглагольное имя. كِتَابَة — писание.",
				drill: "read",
				exampleAr: "كِتَابَةُ الدَّرْسِ",
				exampleRu: "Написание урока."
			}
		]
	},
	{
		...
		lessons: [
			{
				n: 1,
				title: "Смотри и называй",
				minutes: 15,
				goal: "10 вещей",
				teach: "Укажи: كِتَاب، قَلَم، بَاب، مَاء، خُبْز. Не переводи вслух.",
				drill: "letters",
				exampleAr: "هَٰذَا قَلَمٌ",
				exampleRu: "Это ручка."
			},
			{
				n: 2,
				...
				minutes: 15,
				goal: "5 глаголов",
				teach: "قُمْ، اجْلِسْ، اقْرَأْ، اكْتُبْ، اسْمَعْ. Сделай, потом скажи.",
				drill: "harakat",
				exampleAr: "اِقْرَأْ",
				exampleRu: "Читай."
			},
			{
				...
				minutes: 20,
				goal: "повтор",
				teach: "Слушай аят, закрой глаза, верни. Глаза потом.",
				drill: "read",
				exampleAr: "ٱلْحَمْدُ لِلَّهِ",
				exampleRu: "Хвала Аллаху."
			}
		]
	},
	{
...
function IrabDrill() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "text-center text-[11px] uppercase tracking-[0.16em] text-[var(--muted)]",
				children: ["И‘раб · ", item.ref]
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "ayah-ar text-center text-3xl",
				lang: "ar",
				dir: "rtl",
				children: item.ar
			}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					"Слово ",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "ayah-ar inline text-xl",
						lang: "ar",
						children: item.pick
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: item.options.map((o) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					type: "button",
					onClick: () => setPicked(o),
					className: cn("min-h-12 rounded-2xl border px-3 text-sm", picked && o === item.ok && "border-[var(--ok)] text-[var(--ok)]", picked && o === picked && o !== item.ok && "border-[var(--danger)] text-[var(--danger)]", !picked && "border-[var(--line)]"),
					children: o
				}, o))
			}),
			picked ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: ok ? "text-sm text-[var(--ok)]" : "text-sm text-[var(--danger)]",
				children: item.why
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
				variant: "secondary",
				className: "pill",
...
function DrillPanel({ kind, letters }) {
	...
	if (kind === "irab") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(IrabDrill, {});
...
function LearnView() {
	...
	if (!lane) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "Сначала путь. Потом метод. Потом урок."
				})
			]
		}), [
			{
				...
				ru: "Коран",
				ar: "القرآن",
				hint: "Мусхаф, таджвид, тафсир, Иткан."
			},
			{
				id: "arabic",
				ru: "Арабский язык",
				ar: "اللغة العربية",
				hint: "Топ-методики мира, уроки по порядку."
			},
			{
				id: "hifz",
				ru: "Хифз",
				ar: "الحفظ",
				hint: "Заучивание со слухом Хусари. Главный путь."
			}
	...
	if (lane === "arabic" && !method) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "page-pad mx-auto grid max-w-3xl gap-4 px-4 pt-6",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
				className: "font-display text-3xl",
				children: "Методика арабского"
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "text-sm text-[var(--muted)]",
				children: "Пять рабочих школ. Не реклама издательства — как реально учат."
			}),
			ARABIC_METHODS.map((m) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				className: "door text-start",
				onClick: () => setArabicMethod(m.id),
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "ayah-ar block text-lg",
						lang: "ar",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "font-display mt-1 block text-xl",
						children: m.ru
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
	...
	if (lane === "arabic" && method && !course) {
		if (lesson && lessonN > 0) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "page-pad mx-auto grid max-w-3xl gap-4 px-4 pt-6",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				className: "method-back",
				onClick: () => setLessonN(0),
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ChevronLeft, { className: "size-4" }), " Все уроки"]
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				children: [
					...
					lesson.matn ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "ayah-ar mt-4 text-2xl leading-relaxed",
						lang: "ar",
						dir: "rtl",
						children: lesson.matn
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "ayah-ar mt-4 text-3xl",
						lang: "ar",
						dir: "rtl",
						children: lesson.exampleAr
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-2 text-sm text-[var(--muted)]",
						children: lesson.exampleRu
					}),
					lesson.i3rab?.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						className: "mt-3 grid gap-1 text-sm",
						children: lesson.i3rab.map((row) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							className: "flex justify-between gap-2 rounded-xl border border-[var(--line)] px-3 py-2",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "ayah-ar text-xl",
								lang: "ar",
								children: row.word
								...
								children: [row.role, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					lesson.quranEx ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						className: "mt-3 w-full rounded-2xl border border-[var(--line)] p-3 text-start",
						onClick: () => useMizan.getState().setAppTab("quran"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-[11px] uppercase tracking-[0.16em] text-[var(--muted)]",
							children: ["Коран ", lesson.quranRef]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "ayah-ar mt-1 text-2xl",
							lang: "ar",
							dir: "rtl",
							children: lesson.quranEx
						})]
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-4",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DrillPanel, { kind: lesson.drill })
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
							variant: "secondary",
							className: "pill",
							onClick: () => setLessonN(lesson.n <= 1 ? 0 : lesson.n - 1),
							children: "Назад"
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							variant: "glow",
							className: "pill flex-1",
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-sm text-[var(--muted)]",
							children: method.honest
						})
					]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "text-[11px] uppercase tracking-[0.16em] text-[var(--muted)]",
					children: ["Уроки · ", method.lessons.length]
				}),
				method.lessons.map((ls) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					type: "button",
					className: "door text-start",
	...
	if (!course) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-display mt-2 text-3xl tracking-tight",
					children: lane === "hifz" ? "Хифз" : "Коран"
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mx-auto mt-2 max-w-md text-sm text-[var(--muted)]",
					children: lane === "hifz" ? "Слух, повтор, сокрытие. Иджазу даёт живой шейх." : "Мусхаф, таджвид, программа Иткан."
				})]
...
function AyahLine({ ayah, active }) {
	...
	if (!split) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: "ayah-ar ayah-ar-read mt-2",
		lang: "ar",
		dir: "rtl",
		children: ayah.ar
	});
	if (wbw && chips && active && display.some((w) => w.tr || w.gloss)) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: display.map((w, i) => {
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				"data-ayah-word": i,
				className: cn("ayah-wbw-cell", now && "ayah-word-now", done && "ayah-word-done", veil && hi < i && "ayah-word-veil", tajweed && ruleClass(wordRule(w.ar, next))),
				onClick: (e) => {
					e.stopPropagation();
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		className: cn("ayah-ar mt-2", chips ? "ayah-ar-learn" : "ayah-ar-read"),
		lang: "ar",
		dir: "rtl",
		children: display.map((w, i) => {
			const now = hi === i;
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				"data-ayah-word": i,
				className: cn("ayah-word", now && "ayah-word-now", done && "ayah-word-done", veil && hi < i && "ayah-word-veil", tajweed && chips && ruleClass(wordRule(w.ar, next))),
				onClick: (e) => {
					e.stopPropagation();
					playWord(surah, ayah.i, i);
				},
				children: w.ar
			}), i < display.length - 1 ? " " : null] }, i);
		})
	});
}
var TAFSIR_BOOKS = [
...
var yusuf = null;
async function yusufFallback(bookId, ayah) {
	try {
		if (!yusuf) {
...
async function loadTafsir(bookId, surah, ayah) {
...
function TafsirView() {
	...
	(0, import_react.useEffect)(() => {
		...
		setErr("");
		setHit(null);
		loadTafsir(bookId, surah, ayah).then((row) => {
			if (live) setHit(row);
		}).catch(() => {
	...
	(0, import_react.useEffect)(() => {
		loadAyah(surah, ayah).then(setAyahRow);
	}, [surah, ayah]);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						className: "mt-3 pill",
						variant: "secondary",
						onClick: () => playAt(surah, ayah, ayah),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "text-[11px] uppercase tracking-[0.14em] text-[var(--muted)]",
					children: hit?.name ?? bookMeta.ru
				}), hit?.text ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: cn("mt-3 grid gap-3 text-sm leading-relaxed whitespace-pre-wrap", arBook && "ayah-ar text-xl"),
					lang: arBook ? "ar" : "ru",
					dir: arBook ? "rtl" : "ltr",
					children: hit.text
				}) : err ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-3 text-sm text-[var(--muted)]",
...
var MUSHAF_LAYOUTS = [
	{
		id: "page",
		ru: "Страница",
		hint: "Как мусхаф: аяты текут, номер в конце"
	},
	{
		id: "ayah",
		ru: "Аят",
		hint: "Каждый аят отдельной карточкой, письмо цельное"
	},
	{
		id: "words",
		ru: "Слова",
		hint: "Каждое слово отдельно — для обучения"
	}
];
function QuranView() {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: cn("inline-flex min-h-11 flex-1 items-center justify-center gap-1.5 rounded-full border px-3 text-sm", viewMode === "read" ? "border-[var(--accent)] text-[var(--accent)]" : "border-[var(--line)] text-[var(--muted)]"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BookOpen, { className: "size-4" }), " Чтение"]
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						"data-mushaf-mode": "learn",
						onClick: () => setViewMode("learn"),
						className: cn("inline-flex min-h-11 flex-1 items-center justify-center gap-1.5 rounded-full border px-3 text-sm", viewMode === "learn" ? "border-[var(--accent)] text-[var(--accent)]" : "border-[var(--line)] text-[var(--muted)]"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(GraduationCap, { className: "size-4" }), " Обучение"]
					})]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-2 text-xs text-[var(--muted)]",
					children: viewMode === "read" ? "Связный мусхаф. Слова не рвутся. Выбери шрифт." : "Слова отдельно. Таджвид и караоке по чтецу."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-3 flex gap-2 overflow-x-auto pb-1",
					"data-mushaf-fonts": true,
					children: MUSHAF_FONTS.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => setMushafFont(f.id),
						className: cn("inline-flex min-h-11 shrink-0 flex-col items-center justify-center rounded-2xl border px-3 py-1", mushafFont === f.id ? "border-[var(--accent)] text-[var(--accent)]" : "border-[var(--line)] text-[var(--muted)]"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-[11px]",
							children: f.ru
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "ayah-ar text-base leading-none",
							lang: "ar",
							children: f.ar
						})]
					}, f.id))
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-3 flex gap-2 overflow-x-auto pb-1",
					children: MUSHAF_LAYOUTS.map((l) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						type: "button",
						onClick: () => {
						...
						className: cn("inline-flex min-h-11 shrink-0 flex-col items-start rounded-2xl border px-3 py-2 text-left", mushafLayout === l.id ? "border-[var(--accent)] text-[var(--accent)]" : "border-[var(--line)] text-[var(--muted)]"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-sm",
							children: l.ru
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				viewMode === "learn" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
								...
								className: cn("inline-flex min-h-11 items-center gap-1.5 rounded-full border px-3 text-xs", tajweed ? "border-[var(--accent)] text-[var(--accent)]" : "border-[var(--line)] text-[var(--muted)]"),
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Sparkles, { className: "size-3.5" }), "Таджвид"]
							}),
					...
					tajweed ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						"data-go": "tajweed-legend",
						children: TAJWEED_KARAOKE_KEY.map((k) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("i", { style: { background: k.color } }), k.ru] }, k.ru))
					}) : null
				] }) : null,
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
					className: "mt-4 flex gap-2 overflow-x-auto pb-1",
					children: RECITERS.map((r) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						className: cn("inline-flex min-h-11 shrink-0 flex-col items-start justify-center rounded-2xl border px-3 py-2 text-left text-xs", r.id === reciterId ? "border-[var(--accent)] text-[var(--accent)]" : "border-[var(--line)] text-[var(--muted)]"),
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-3 flex flex-wrap gap-2",
					children: [
						playing ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							variant: "glow",
							onClick: toggle,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Pause, { className: "size-4" }), " Пауза"]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							variant: "secondary",
							className: "pill",
							onClick: stop,
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Square, { className: "size-3.5 fill-current" }), " Стоп"]
						})] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							variant: "glow",
				...
				mushafLayout === "page" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					windowed[0] && windowed[0].i > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
					...
					windowed.length && windowed[windowed.length - 1].i < meta.ayahs ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
						type: "button",
						className: "mt-3 text-sm text-[var(--muted)]",
				...
				mushafLayout === "page" && current ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "mt-4 rounded-[24px] border border-[var(--line)] bg-[var(--surface)] p-4",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "text-[11px] tabular-nums text-[var(--muted)]",
							children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 text-sm leading-relaxed",
							children: current.ayahs.find((x) => x.i === ayah)?.ru
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
				...
				mushafLayout !== "page" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ol", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					...
					onClick: async () => {
						if (await requestNotify() === "granted") {
							const { showSabrNow } = await import("./notify-DB4Ab4Yx.mjs");
							await showSabrNow();
...
function StudyGate() {
	...
	(0, import_react.useEffect)(() => {
		const t = window.setInterval(() => {
			if (playing || tab === "quran" || tab === "learn" || tab === "hisn") addStudyMs(1e4);
			setLocked(!user && guestLocked());
			if (user) pushStudyMs({ data: { studyMs: readStudyMs() } }).catch(() => {});
		}, 1e4);
		setLocked(!user && guestLocked());
	...
	const used = Math.round(readStudyMs() / 36e5);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: "fixed inset-0 z-[85] grid place-items-center bg-[color-mix(in_oklab,var(--bg)_88%,black)] p-6",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
					className: "font-display mt-2 text-3xl",
					children: "Два часа прошли"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "mt-3 text-sm text-[var(--muted)]",
					children: [used, " ч учёбы как гость. Дальше нужен кабинет: Google, почта или X. Прогресс и память шейха лягут на сервер."]
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
					to: "/login",
					className: "btn-glow mt-5 grid min-h-12 place-items-center rounded-full",
					children: "Войти и продолжить"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
					className: "mt-3 text-[11px] text-[var(--muted)]",
					children: [
						"Лимит гостя — ",
						Math.round(FREE_MS / 36e5),
						" часа."
					]
				})
			]
...
function Header() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
		...
		children: [
			...
			back ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				className: "flex min-w-0 flex-1 items-center gap-2 text-left",
				onClick: goHome,
				"aria-label": "На главную",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrandMark, { size: 36 }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function MizanApp() {
	...
	(0, import_react.useEffect)(() => {
		...
		hydrateHisn();
		parseHash();
		import("./server-c9Bchaf7.mjs").then(({ pullStudy }) => pullStudy()).then((d) => {
			const row = d.progress?.find((p) => p.lane !== "none") ?? d.progress?.[0];
			if (row?.payload) applyServerProgress(row.payload);
		}).catch(() => {});
		if (typeof navigator !== "undefined" && /MizanNative/.test(navigator.userAgent)) document.documentElement.classList.add("mizan-native");
		if (!location.hash) {
		...
		const onMsg = (e) => {
			...
			if (e.data?.type === "SABR_DUE") {
				if (useMizan.getState().settings.sabrNotify) import("./notify-DB4Ab4Yx.mjs").then((m) => m.showSabrNow());
			}
		};
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			chromeOff ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PlayerBar, {}),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CabinetSheet, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StudyGate, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StudyGate, {})
		]
	});
}
...
//#endregion
export { pushStudyMs as a, nextSabrDate as c, Home as component, registerSw as d, requestNotify as f, routes_CczT8q8W_exports as g, startSabrDaily as h, pushProgress as i, nextSabrLabel as l, shownToday as m, dumpStudy as n, armSabrTimer as o, showSabrNow as p, pullStudy as r, bootNotify as s, addMemory as t, notifySupported as u };
